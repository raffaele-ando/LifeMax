/* PRIMI PASSI — cosa fa l'app, in tre passaggi e poi il resto.
   ...
   Il testo di ogni voce porta dentro del markup (un <b>, un <kbd>): è la
   stessa stringa del codice di prima, e si mette com'è. Riscriverla in JSX
   vorrebbe dire due copie dello stesso paragrafo, ed è il tipo di doppione
   che poi diverge senza che nessuno se ne accorga.  */
