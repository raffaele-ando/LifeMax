...
function countUp(el: HTMLElement, to: number, opzioni?: OpzContatore): void {
...
function flyXp(x: number, y: number, punti: number): void {
...
function abilitaTrascina(scope: ParentNode, onRilascio: (id: string, bersaglio: HTMLElement, x: number, y: number) => void): void {
...
function oraDi(ts: number): string {
  var d = new Date(ts);
